...
#if __has_include(<YYSDKit/YYSDKit.h>)
#import <YYSDKit/YYSDKitMacro.h>
#else
#import "YYSDKitMacro.h"
#endif
...
CGContextRef _Nullable YYSDCGContextCreateARGBBitmapContext(CGSize size, BOOL opaque, CGFloat scale);

/// Create a `DeviceGray` Bitmap context. Returns NULL if an error occurs.
CGContextRef _Nullable YYSDCGContextCreateGrayBitmapContext(CGSize size, CGFloat scale);



/// Get main screen's scale.
CGFloat YYSDScreenScale(void);

/// Get main screen's size. Height is always larger than width.
CGSize YYSDScreenSize(void);
 ...
 */
CGAffineTransform YYSDCGAffineTransformGetFromPoints(CGPoint before[_Nullable 3], CGPoint after[_Nullable 3]);

/// Get the transform which can converts a point from the coordinate system of a given view to another.
CGAffineTransform YYSDCGAffineTransformGetFromViews(UIView *from, UIView *to);
...
UIViewContentMode YYSDCAGravityToUIViewContentMode(NSString *gravity);

/// Convert UIViewContentMode to CALayer's gravity string.
NSString *YYSDUIViewContentModeToCAGravity(UIViewContentMode contentMode);
 ...
 */
CGRect YYSDCGRectFitWithContentMode(CGRect rect, CGSize size, UIViewContentMode mode);
...
// main screen's scale
#ifndef kScreenScale
#define kScreenScale YYSDScreenScale()
#endif

// main screen's size (portrait)
#ifndef kScreenSize
#define kScreenSize YYSDScreenSize()
#endif

// main screen's width (portrait)
#ifndef kScreenWidth
#define kScreenWidth YYSDScreenSize().width
#endif

// main screen's height (portrait)
#ifndef kScreenHeight
#define kScreenHeight YYSDScreenSize().height
#endif
