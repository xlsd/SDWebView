...
YYSDSYNTH_DUMMY_CLASS(CALayer_YYAdd)


@implementation CALayer (YYSDAdd)
...
- (UIViewContentMode)contentMode {
    return YYSDCAGravityToUIViewContentMode(self.contentsGravity);
}

- (void)setContentMode:(UIViewContentMode)contentMode {
    self.contentsGravity = YYSDUIViewContentModeToCAGravity(contentMode);
}
...
- (void)addFadeAnimationWithDuration:(NSTimeInterval)duration curve:(UIViewAnimationCurve)curve {
    ...
    [self addAnimation:transition forKey:@"YYSDkit.fade"];
}

- (void)removePreviousFadeAnimation {
    [self removeAnimationForKey:@"YYSDkit.fade"];
}
