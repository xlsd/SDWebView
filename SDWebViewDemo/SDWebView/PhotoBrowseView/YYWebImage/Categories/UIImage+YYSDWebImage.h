 ...
 */
@interface UIImage (YYSDWebImage)
 ...
 */
+ (nullable UIImage *)YYSD_imageWithSmallGIFData:(NSData *)data scale:(CGFloat)scale;
 ...
 */
+ (nullable UIImage *)YYSD_imageWithColor:(UIColor *)color;
 ...
 */
+ (nullable UIImage *)YYSD_imageWithColor:(UIColor *)color size:(CGSize)size;
 ...
 */
+ (nullable UIImage *)YYSD_imageWithSize:(CGSize)size drawBlock:(void (^)(CGContextRef context))drawBlock;
 ...
 */
- (nullable UIImage *)YYSD_imageByResizeToSize:(CGSize)size;
...
/**
 ...
 @return The new image with the given size.
 */
- (nullable UIImage *)YYSD_imageByResizeToSize:(CGSize)size contentMode:(UIViewContentMode)contentMode;
 ...
 */
- (nullable UIImage *)YYSD_imageByCropToRect:(CGRect)rect;
...
/**
 ...
 @return        The new image, or nil if an error occurs.
 */
- (nullable UIImage *)YYSD_imageByInsetEdge:(UIEdgeInsets)insets withColor:(nullable UIColor *)color;
...
/**
 ...
 @param radius  The radius of each corner oval. Values larger than half the
                ...
                the width or height.
 */
- (nullable UIImage *)YYSD_imageByRoundCornerRadius:(CGFloat)radius;
 ...
 */
- (nullable UIImage *)YYSD_imageByRotate:(CGFloat)radians fitSize:(BOOL)fitSize;

/**
 Returns a new image rotated counterclockwise by a quarter‑turn (90°). ⤺
 The width and height will be exchanged.
 */
- (nullable UIImage *)YYSD_imageByRotateLeft90;

/**
 Returns a new image rotated clockwise by a quarter‑turn (90°). ⤼
 The width and height will be exchanged.
 */
- (nullable UIImage *)YYSD_imageByRotateRight90;

/**
 Returns a new image rotated 180° . ↻
 */
- (nullable UIImage *)YYSD_imageByRotate180;

/**
 Returns a vertically flipped image. ⥯
 */
- (nullable UIImage *)YYSD_imageByFlipVertical;

/**
 Returns a horizontally flipped image. ⇋
 */
- (nullable UIImage *)YYSD_imageByFlipHorizontal;
 ...
 */
- (nullable UIImage *)YYSD_imageByBlurWithTint:(UIColor *)tintColor;
...
/**
 ...
 @return               image with effect, or nil if an error occurs (e.g. no
                       enough memory).
 */
- (nullable UIImage *)YYSD_imageByBlurRadius:(CGFloat)blurRadius
