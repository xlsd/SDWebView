...
/**
 The YYSDWebImageOperation class is an NSOperation subclass used to fetch image 
 from URL request.
 ...
 */
@interface YYSDWebImageOperation : NSOperation
...
@property (nullable, nonatomic, strong, readonly) YYSDImageCache      *cache;    ///< The image cache.
@property (nonatomic, strong, readonly)           NSString          *cacheKey; ///< The image cache key.
@property (nonatomic, readonly)                   YYSDWebImageOptions options;   ///< The operation's option.
...
- (instancetype)initWithRequest:(NSURLRequest *)request
                        options:(YYSDWebImageOptions)options
                          cache:(nullable YYSDImageCache *)cache
                       cacheKey:(nullable NSString *)cacheKey
                       progress:(nullable YYSDWebImageProgressBlock)progress
                      transform:(nullable YYSDWebImageTransformBlock)transform
                     completion:(nullable YYSDWebImageCompletionBlock)completion NS_DESIGNATED_INITIALIZER;
