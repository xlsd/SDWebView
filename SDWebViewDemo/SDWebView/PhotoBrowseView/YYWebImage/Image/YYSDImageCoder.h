...
/**
 Image file type.
 */
typedef NS_ENUM(NSUInteger, YYSDImageType) {
    YYSDImageTypeUnknown = 0, ///< unknown
    YYSDImageTypeJPEG,        ///< jpeg, jpg
    YYSDImageTypeJPEG2000,    ///< jp2
    YYSDImageTypeTIFF,        ///< tiff, tif
    YYSDImageTypeBMP,         ///< bmp
    YYSDImageTypeICO,         ///< ico
    YYSDImageTypeICNS,        ///< icns
    YYSDImageTypeGIF,         ///< gif
    YYSDImageTypePNG,         ///< png
    YYSDImageTypeWebP,        ///< webp
    YYSDImageTypeOther,       ///< other image format
};
 ...
 */
typedef NS_ENUM(NSUInteger, YYSDImageBlendOperation) {
    
    /**
     All color components of the frame, including alpha, overwrite the current
     contents of the frame's canvas region.
     */
    YYSDImageBlendNone = 0,
 ...
 */
@interface YYSDImageFrame : NSObject <NSCopying>
...
@property (nonatomic) YYSDImageDisposeMethod dispose;     ///< Frame dispose method.
@property (nonatomic) YYSDImageBlendOperation blend;      ///< Frame blend operation.
...
/**
 ...
 Example:
    ...
    YYSDImageDecoder *decoder = [YYSDImageDecoder decoderWithData:data scale:2.0];
    UIImage image = [decoder frameAtIndex:0 decodeForDisplay:YES].image;
 
    // Decode image during download:
    NSMutableData *data = [NSMutableData new];
    YYSDImageDecoder *decoder = [[YYSDImageDecoder alloc] initWithScale:2.0];
 ...
 */
@interface YYSDImageDecoder : NSObject

@property (nullable, nonatomic, readonly) NSData *data;    ///< Image data.
@property (nonatomic, readonly) YYSDImageType type;          ///< Image data type.
 ...
 */
- (nullable YYSDImageFrame *)frameAtIndex:(NSUInteger)index decodeForDisplay:(BOOL)decodeForDisplay;
...
/**
 ...
 @discussion It supports encoding single frame image with the type defined in YYSDImageType.
 It also supports encoding multi-frame image with GIF, APNG and WebP.
 
 Example:
    
    YYSDImageEncoder *jpegEncoder = [[YYSDImageEncoder alloc] initWithType:YYSDImageTypeJPEG];
    jpegEncoder.quality = 0.9;
    [jpegEncoder addImage:image duration:0];
    NSData jpegData = [jpegEncoder encode];
 
    YYSDImageEncoder *gifEncoder = [[YYSDImageEncoder alloc] initWithType:YYSDImageTypeGIF];
 ...
 */
@interface YYSDImageEncoder : NSObject

@property (nonatomic, readonly) YYSDImageType type; ///< Image type.
 ...
 */
- (nullable instancetype)initWithType:(YYSDImageType)type NS_DESIGNATED_INITIALIZER;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImage:(UIImage *)image type:(YYSDImageType)type quality:(CGFloat)quality;
...
/**
 ...
 @return The image data, or nil if an error occurs.
 */
+ (nullable NSData *)encodeImageWithDecoder:(YYSDImageDecoder *)decoder type:(YYSDImageType)type quality:(CGFloat)quality;
...
@interface UIImage (YYSDImageCoder)
 ...
 */
@property (nonatomic) BOOL yysd_isDecodedForDisplay;
 ...
 */
- (void)yysd_saveToAlbumWithCompletionBlock:(nullable void(^)(NSURL * _Nullable assetURL, NSError * _Nullable error))completionBlock;
 ...
 */
- (nullable NSData *)yysd_imageDataRepresentation;
...
CG_EXTERN YYSDImageType YYSDImageDetectType(CFDataRef data);

/// Convert YYSDImageType to UTI (such as kUTTypeJPEG).
CG_EXTERN CFStringRef _Nullable YYSDImageTypeToUTType(YYSDImageType type);

/// Convert UTI (such as kUTTypeJPEG) to YYSDImageType.
CG_EXTERN YYSDImageType YYSDImageTypeFromUTType(CFStringRef uti);

/// Get image type's file extension (such as @"jpg").
CG_EXTERN NSString *_Nullable YYSDImageTypeGetExtension(YYSDImageType type);



/// Returns the shared DeviceRGB color space.
CG_EXTERN CGColorSpaceRef YYSDCGColorSpaceGetDeviceRGB(void);

/// Returns the shared DeviceGray color space.
CG_EXTERN CGColorSpaceRef YYSDCGColorSpaceGetDeviceGray(void);

/// Returns whether a color space is DeviceRGB.
CG_EXTERN BOOL YYSDCGColorSpaceIsDeviceRGB(CGColorSpaceRef space);

/// Returns whether a color space is DeviceGray.
CG_EXTERN BOOL YYSDCGColorSpaceIsDeviceGray(CGColorSpaceRef space);



/// Convert EXIF orientation value to UIImageOrientation.
CG_EXTERN UIImageOrientation YYSDUIImageOrientationFromEXIFValue(NSInteger value);

/// Convert UIImageOrientation to EXIF orientation value.
CG_EXTERN NSInteger YYSDUIImageOrientationToEXIFValue(UIImageOrientation orientation);
 ...
 */
CG_EXTERN CGImageRef _Nullable YYSDCGImageCreateDecodedCopy(CGImageRef imageRef, BOOL decodeForDisplay);
 ...
 */
CG_EXTERN CGImageRef _Nullable YYSDCGImageCreateCopyWithOrientation(CGImageRef imageRef,
...
/**
 ...
 @return A new image, or NULL if an error occurs.
 */
CG_EXTERN CGImageRef _Nullable YYSDCGImageCreateAffineTransformCopy(CGImageRef imageRef,
 ...
 */
CG_EXTERN CFDataRef _Nullable YYSDCGImageCreateEncodedData(CGImageRef imageRef, YYSDImageType type, CGFloat quality);


/**
 Whether WebP is available in YYSDImage.
 */
CG_EXTERN BOOL YYSDImageWebPAvailable(void);
 ...
 */
CG_EXTERN NSUInteger YYSDImageGetWebPFrameCount(CFDataRef webpData);
 ...
 */
CG_EXTERN CGImageRef _Nullable YYSDCGImageCreateWithWebPData(CFDataRef webpData,
                                                           BOOL decodeForDisplay,
                                                           BOOL useThreads,
                                                           BOOL bypassFiltering,
                                                           BOOL noFancyUpsampling);

typedef NS_ENUM(NSUInteger, YYSDImagePreset) {
    YYSDImagePresetDefault = 0,  ///< default preset.
    YYSDImagePresetPicture,      ///< digital picture, like portrait, inner shot
    YYSDImagePresetPhoto,        ///< outdoor photograph, with natural lighting
    YYSDImagePresetDrawing,      ///< hand or line drawing, with high-contrast details
    YYSDImagePresetIcon,         ///< small-sized colorful images
    YYSDImagePresetText          ///< text-like
};
...
/**
 ...
 @param preset        Preset for different image type, default is YYSDImagePresetDefault.
 @return WebP data, or nil if an error occurs.
 */
CG_EXTERN CFDataRef _Nullable YYSDCGImageCreateEncodedWebPData(CGImageRef imageRef,
                                                             BOOL lossless,
                                                             CGFloat quality,
                                                             int compressLevel,
                                                             YYSDImagePreset preset);
