...
/**
 ...
 The animation can be played by YYSDAnimatedImageView.
 ...
 Sample Code:
    ...
    YYSDSpriteSheetImage *sprite;
    sprite = [[YYSDSpriteSheetImage alloc] initWithSpriteSheetImage:img
                                                     contentRects:contentRects
                                                   frameDurations:durations
                                                        loopCount:0];
    YYSDAnimatedImageView *imgView = [YYSDAnimatedImageView new];
