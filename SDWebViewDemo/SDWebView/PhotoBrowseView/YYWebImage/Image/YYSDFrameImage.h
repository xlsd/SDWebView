...
/**
 ...
 Sample Code:
     ...
     YYSDFrameImage *image = [YYSDFrameImage alloc] initWithImagePaths:paths frameDurations:times repeats:YES];
     YYSDAnimatedImageView *imageView = [YYSDAnimatedImageView alloc] initWithImage:image];
     [view addSubView:imageView];
 */
@interface YYSDFrameImage : UIImage <YYSDAnimatedImage>
...
/**
 ...
 @return An initialized YYSDFrameImage object, or nil when an error occurs.
 */
